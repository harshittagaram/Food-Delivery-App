              ...
              <form className="needs-validation" noValidate>
                <div className="row g-3">
                  <div className="col-sm-6">
                    ...
                    <input type="text" className="form-control" id="firstName" placeholder='Harshit' required />
                  </div>

                  <div className="col-sm-6">
                    <label htmlFor="lastName" className="form-label">Last name</label>
                    <input type="text" className="form-control" id="lastName" placeholder='Tagaram' required />
                  </div>
                  ...
                  <div className="col-12">
                    ...
                    <input type="number" className="form-control" id="phone" placeholder="+91 ***** *****" required />
                  </div>
                  ...
                  <div className="col-md-3">
                    ...
                    <input type="text" className="form-control" id="zip" placeholder='507116' required />
                  </div>
                </div>
